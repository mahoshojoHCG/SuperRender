...
internal sealed class JsDocumentWrapper : JsElementWrapper
{
    ...
    public JsDocumentWrapper(Document document, NodeWrapperCache cache, Realm realm)
    ...
    private static Element CreateDummyElement(Document doc) => doc.CreateElement("html");
