...
public sealed class HtmlParser
{
    ...
    private static void HandleStartTag(HtmlToken token, Document doc, Stack<Element> openElements)
    {
    ...
    private static void HandleText(HtmlToken token, Document doc, Stack<Element> openElements)
    {
        var text = token.Text;
    ...
    /// </summary>
    private static void EnsureStructure(Document doc)
    {
    ...
    private static void EnsureHeadAndBody(Document doc, Element htmlElement)
    {
