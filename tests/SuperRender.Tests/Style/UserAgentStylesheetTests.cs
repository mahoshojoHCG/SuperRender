...
public class UserAgentStylesheetTests
{
    ...
    {
        var parser = new SuperRender.Core.Html.HtmlParser(html);
    ...
    {
        var parser = new SuperRender.Core.Html.HtmlParser("<strong>text</strong>");
        var doc = parser.Parse();
    ...
    {
        var parser = new SuperRender.Core.Html.HtmlParser("<a href=\"#\">text</a>");
        var doc = parser.Parse();
